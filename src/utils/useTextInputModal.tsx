/**
 * Local useTextInputModal hook and TextInputModal component.
 * Migrated from @console/shared/src/hooks/useTextInputModal and
 * @console/shared/src/components/modals/TextInputModal.
 */
