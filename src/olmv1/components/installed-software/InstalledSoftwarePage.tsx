...
import { NamespaceBar } from '../../../utils/misc-shims';
import { AsyncComponent } from '../../../utils/utils-shims';
import type { Page } from '../../../utils/factory-shims';
// TODO: migrate MultiTabListPage - replace shim with SDK HorizontalNav-based implementation
import { MultiTabListPage } from '../../../utils/shared-shims';
