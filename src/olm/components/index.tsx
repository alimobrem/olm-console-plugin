...
export const providedAPIForModel = (csv: ClusterServiceVersionKind, model: K8sModel): ProvidedAPI =>
...
export const exampleForModel = (csv: ClusterServiceVersionKind, model: K8sModel) =>
  _.defaultsDeep(
    {},
    {
      kind: model.kind,
