...
jest.mock('@openshift-console/dynamic-plugin-sdk/src/utils/k8s/k8s-resource', () => ({
  ...jest.requireActual('@openshift-console/dynamic-plugin-sdk/src/utils/k8s/k8s-resource'),
  k8sUpdate: jest.fn(),
}));
...
jest.mock('@openshift-console/dynamic-plugin-sdk/src/app/modal-support/useOverlay', () => ({
...
describe('ResourceRequirementsModal', () => {
  ...
  it('should call k8sUpdate when form is submitted', async () => {
    ...
    const [model, newObj] = k8sUpdateMock.mock.calls[0] as [K8sModel, K8sResourceKind];
