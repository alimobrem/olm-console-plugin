...
const MatchExpressionRow: FC<MatchExpressionProps> = ({
  expression,
  onChange = () => {},
  ...
  return (
    <Tr>
      <Td dataLabel={t('console-shared~Key')}>
      ...
      <Td dataLabel={t('console-shared~Operator')}>
        <ConsoleSelect
          isFullWidth
      ...
      <Td dataLabel={t('console-shared~Values')}>
        <span
...
export const MatchExpressions: FC<MatchExpressionsProps> = ({
  ...
  return (
    <Table aria-label={t('console-shared~Match expressions')} variant="compact" borders={false}>
      <Thead>
        <Tr>
          <Th>{t('console-shared~Key')}</Th>
          <Th>{t('console-shared~Operator')}</Th>
          <Th>{t('console-shared~Values')}</Th>
          <Th />
        </Tr>
      </Thead>
      <Tbody>
        ...
        <Tr>
          <Td>
            <Button
              ...
              variant="link"
            >
              {t('console-shared~Add expression')}
            </Button>
          </Td>
        </Tr>
      </Tbody>
